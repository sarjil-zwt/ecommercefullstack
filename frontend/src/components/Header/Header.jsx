      ...
      <div className="headerright">
        ...
        <div className="headerrightlogoitemswrapper">
          {userState.isLoggedIn ? (
            ...
            <Link to="/login" className="headerlogoitem">
              <HiOutlineLogin className="headerlogoitemlogo" />
              <p className="headerlogoitemtxt">Login</p>
            </Link>
          )}
          <Link to="/" className="headerlogoitem">
            <FaRegHeart className="headerlogoitemlogo" />
